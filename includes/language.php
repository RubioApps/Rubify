...
class Language
{
     ...
     *
     */
    public function getKnownLanguages($basePath = RBFY_SITE)
    {
    ...
    public function getLanguages($key = 'default')
    {
        ...
        if (empty($this->languages)) {
            $languages[$key] = array();
            $knownLangs = $this->getKnownLanguages(RBFY_SITE);
     ...
     */
    public function getLanguagePath($basePath = RBFY_SITE, $language = null)
    {
    ...
    public function getMetadata($lang)
    {
        ...
        $file = $this->getLanguagePath(RBFY_SITE, $lang) . '/langmetadata.xml';

        if (!is_file($file)) {
            $file = $this->getLanguagePath(RBFY_SITE, $lang) . '/' . $lang . '.xml';
        }
     ...
     *
     */
    public function load($basePath = RBFY_SITE, $lang = null, $reload = false, $default = true)
    {
